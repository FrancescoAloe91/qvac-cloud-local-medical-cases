...
_STRINGS = {
    "en": {
        ...
        "cloud.demo_link": "Local setup: [GitHub README](https://github.com/FrancescoAloe91/qvac-cloud-local-medical-cases) · [Live demo](https://qvac-cloud-local-medical-cases.streamlit.app)",
    ...
    "it": {
        ...
        "cloud.demo_link": "Setup locale: [README GitHub](https://github.com/FrancescoAloe91/qvac-cloud-local-medical-cases) · [Demo live](https://qvac-cloud-local-medical-cases.streamlit.app)",
