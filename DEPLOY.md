...
**Repo:** `alofrankys/qvac-cloud-local-medical-cases` · branch `main` ·
...
1. Open [share.streamlit.io](https://share.streamlit.io) and sign in with the
   GitHub account that owns `alofrankys/qvac-cloud-local-medical-cases`
...
3. **New app** → choose repository
   `alofrankys/qvac-cloud-local-medical-cases`, branch `main`,
